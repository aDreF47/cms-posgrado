...
const AdmisionPage = () => {
  ...
  const programasDisponibles = [
    {
      ...
      vacantes: 50,
      requisitos: [
        "Grado de Bachiller en Educación o afines",
        "Certificado SUNEDU",
    ...
    },
    {
      ...
      vacantes: 40,
      requisitos: [
        "Grado de Bachiller en Matemática, Educación Matemática o afines",
        "Certificado SUNEDU",
        "3 años de experiencia docente",
      ],
    },
    {
      ...
      requisitos: [
        "Grado de Bachiller en Educación o afines",
        "Certificado SUNEDU",
        "2 años de experiencia en el sector educativo",
      ],
    },
    {
      id: 4,
      ...
      vacantes: 45,
      requisitos: [
        "Grado de Bachiller en cualquier especialidad",
        "Certificado SUNEDU",
    ...
    },
    {
      ...
      vacantes: 40,
      requisitos: [
        "Grado de Maestro en Educación o afines",
        "Certificado SUNEDU",
  ...
  const documentosRequeridos = [
    {
      ...
      copia: false,
      detalle:
        "Formato oficial de la Unidad de Posgrado, debidamente llenado y firmado",
    },
    {
    ...
    },
    {
      ...
      copia: true,
      detalle:
        "Nivel intermedio (Inglés, Francés, Italiano o Portugués) - Solo para Doctorado",
    },
    {
  ...
  const formasPago = [
    {
      ...
      descripcion: "Pago mediante la plataforma San Market",
  ...
  const renderCronograma = () => (
    <div id="cronograma" className="space-y-8">
      {/* Header */}
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">
          Cronograma de Admisión 2025-II
        </h2>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Proceso de Admisión para programas de Maestría y Doctorado en
          Educación - UNMSM
        </p>
      </div>
                ...
                <div key={step.id} className="relative">
                  <div
                    className={`bg-white rounded-xl p-6 border-2 ${getStatusBorderColor(
                      step.status
                    )} shadow-lg h-85 flex flex-col justify-between transition-all duration-300 hover:shadow-xl`}
                  >
                    <div className="text-center">
                      <div
                      ...
                      <p className="text-[#A41E22] font-medium text-sm mb-2">
                        {step.date}
                      </p>
  ...
  const renderRequisitos = () => (
    <div id="requisitos" className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">
          Requisitos de Postulación
        </h2>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Requisitos específicos según el programa académico al que deseas
          postular
        </p>
      </div>
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div className="flex items-center text-gray-600">
                    <span className="text-[#A41E22] mr-2">
  ...
  const renderInscripcion = () => (
    <div id="inscripcion" className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <span className="font-semibold text-[#A41E22]">
                {costosInscripcion.maestria.inscripcion}
              </span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              <span className="text-gray-600">Exámenes y evaluación:</span>
              <span className="font-semibold text-[#A41E22]">
                {costosInscripcion.maestria.examenes}
              </span>
            </div>
            <div className="flex justify-between items-center py-2 bg-gray-50 px-3 rounded">
              <span className="font-semibold text-gray-800">Total:</span>
              <span className="font-bold text-xl text-[#A41E22]">
                {costosInscripcion.maestria.total}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              <span className="text-gray-600">Derecho de inscripción:</span>
              <span className="font-semibold text-[#A41E22]">
                {costosInscripcion.doctorado.inscripcion}
              </span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              <span className="text-gray-600">Exámenes y evaluación:</span>
              <span className="font-semibold text-[#A41E22]">
                {costosInscripcion.doctorado.examenes}
              </span>
            </div>
            <div className="flex justify-between items-center py-2 bg-gray-50 px-3 rounded">
              <span className="font-semibold text-gray-800">Total:</span>
              <span className="font-bold text-xl text-[#A41E22]">
                {costosInscripcion.doctorado.total}
              </span>
            </div>
          </div>
        </div>
      ...
      {/* Pasos del Proceso - VERSIÓN CORREGIDA */}
          ...
          {[
            {
              ...
              descripcion:
                "Realizar el pago correspondiente según el programa elegido",
              icono: MdPayment,
            },
            {
              paso: 2,
              titulo: "Documentos",
              descripcion:
                "Reunir todos los documentos requeridos según el programa",
              icono: MdDescription,
            },
            {
              paso: 3,
              ...
              descripcion:
                "Enviar expediente completo al email oficial de la Unidad",
              icono: MdEmail,
            },
            {
              paso: 4,
            ...
            // ✅ ESTA ES LA LÍNEA CLAVE - Extraer el componente
            const IconComponent = paso.icono;

            return (
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-[#A41E22] rounded-full flex items-center justify-center text-white mx-auto mb-4 shadow-lg">
                  {/* ✅ Renderizar correctamente el componente */}
  ...
  const renderExamen = () => (
    <div id="examen" className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">
          Examen de Aptitud
        </h2>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Información sobre la evaluación de conocimientos para ingreso a
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
            <span className="text-2xl mr-3"><MdLibraryBooks className="text-lg" /></span>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
            <span className="text-2xl mr-3"><MdSchool className="text-lg" /></span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={index} className="bg-white rounded-lg p-6 shadow-lg">
              <h4 className="text-lg font-semibold text-[#A41E22] mb-3">
                {seccion.area}
              </h4>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li className="border-l-4 border-[#A41E22] pl-3">
                <strong>Fundamentos de Educación:</strong>
                <br />
  ...
  const renderResultados = () => (
    <div id="resultados" className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Información sobre publicación de resultados y próximos pasos para
          admitidos
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white/10 rounded-lg p-6">
            ...
            <p className="text-sm opacity-90">
              Publicación en portal web y sede universitaria
            </p>
          </div>
          <div className="bg-white/10 rounded-lg p-6">
            ...
            <p className="text-sm opacity-90">
              Tras evaluación de reconsideraciones
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 text-center">
          ...
          <p className="text-sm text-gray-600">
            Evaluación escrita de conocimientos específicos
          </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 text-center">
          ...
          <p className="text-sm text-gray-600">
            Suma ponderada de ambas evaluaciones
          </p>
      ...
      <div className="bg-gray-50 rounded-xl p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h4 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
              <span className="text-xl mr-2"><MdCheckCircle className="text-lg" /></span>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li className="flex items-start">
                ...
                <div>
                  <strong>Ratificación de matrícula</strong>
                  <br />
              ...
              <li className="flex items-start">
                ...
                <div>
                  <strong>Inducción académica</strong>
                  <br />
          ...
          <div>
            <h4 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
              <span className="text-xl mr-2"><MdLibraryBooks className="text-lg" /></span>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Contacta a la Unidad de Posgrado para resolver tus dudas
        </p>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="flex items-center justify-center space-x-2">
            <span className="text-[#A41E22]"><MdEmail className="text-lg" /></span>
            <span className="text-sm">posgrado.educacion@unmsm.edu.pe</span>
          </div>
          <div className="flex items-center justify-center space-x-2">
            <span className="text-[#A41E22]"><MdPhone className="text-lg" /></span>
            <span className="text-sm">(01) 619-7000 ext. 3021</span>
          </div>
          <div className="flex items-center justify-center space-x-2">
            
            <span className="text-[#A41E22]"><FaWhatsapp className="text-xl" /></span>
      ...
      <div className="bg-gradient-to-r from-[#A41E22] to-red-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Comienza tu proceso de admisión a los programas de posgrado de la
            UNMSM
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() =>
                window.open(
                  "https://posgradoeducacion.unmsm.edu.pe/admision",
                  "_blank"
                )
              }
            ...
            <button
              onClick={() =>
                window.open(
                  "https://wa.me/51965229338?text=Hola,%20necesito%20información%20sobre%20admisión%20posgrado",
                  "_blank"
                )
              }
